...
--1141. Активность пользователей за последние 30 дней I
https://leetcode.com/problems/user-activity-for-the-past-30-days-i/description/

/*
Напишите решение, чтобы найти ежедневное количество активных пользователей в течение 30 дней, заканчивающихся 27.07.2019 включительно. Когда-нибудь пользователь был активен, если он совершил хотя бы одно действие в этот день.
...
| 2019-07-21 | 2            |
+------------+--------------+ 
Explanation: Note that we do not 
*/
...
--1978. Сотрудники, чей руководитель покинул компанию
https://leetcode.com/problems/employees-whose-manager-left-the-company/

/*
Найдите идентификаторы сотрудников, чья зарплата строго меньше 30000 долларов США и чей менеджер покинул компанию. Когда менеджер покидает компанию, его информация удаляется из таблицы "Сотрудники", но в отчетах все еще установлен менеджер_id для менеджера, который ушел.
...
Сотрудники с зарплатой менее 30000 долларов США - 1 (Калель) и 11 (Джозия).

Менеджер Калеля - сотрудник 11, который все еще работает в компании (Джозия).

Менеджер Джозии - сотрудник 6, который покинул компанию, потому что нет ряда для сотрудника 6, так как она была удалена.
*/
